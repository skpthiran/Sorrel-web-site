  ...
  return (
    <footer className="bg-black border-t-4 border-cyan relative overflow-hidden">
      ...
      <div className="marquee-container py-6 border-b border-gray-800 bg-cyan/5">
        <div className="marquee-content font-display text-4xl md:text-6xl text-cyan/50 tracking-widest">
      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
          ...
          <div className="space-y-4">
            <h2 className="font-display text-5xl md:text-7xl text-chrome">TERMINAL</h2>
          ...
          <div className="flex flex-col space-y-6 text-left md:text-right">
            <a href="#" className="font-display text-3xl md:text-5xl text-gray-400 hover:text-cyan transition-colors relative group w-fit md:ml-auto">
              [ INSTITUTIONAL DECK ]
        ...
        <div className="mt-32 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4 font-mono text-xs text-gray-600">
